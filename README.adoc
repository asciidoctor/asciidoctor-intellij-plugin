...
An AsciiDoc editor for the IntelliJ platform (IntelliJ IDEA, RubyMine, etc). It provides support for the
http://www.asciidoc.org[AsciiDoc] markup language and has features like live preview, conversion from Markdown to
AsciiDoc, and much more.
