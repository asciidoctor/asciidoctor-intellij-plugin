...
NOTE: The API of Grazie changed recently, therefore use the following minimum versions: IntelliJ (2019.2.1), Grazie plugin (2019.2-5.3.stable) and AsciiDoc plugin (0.30.18).
