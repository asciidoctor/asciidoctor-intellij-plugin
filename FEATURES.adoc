...
* Attribute _partialsdir_ resolves to the absolute path of the partials folder of the current module (either at the top-level of the module, or below the pages folder). This way the following resolves in the editor and the preview:
+
----
