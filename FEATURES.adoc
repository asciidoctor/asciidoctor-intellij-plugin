...
Once the user installed the https://plugins.jetbrains.com/plugin/12175-grazie/[Grazie plugin] version 2019.2-5.3.stable or later the editor highlights possible grammar mistakes.
...
The user can enable spell checking in Grazie.
...
NOTE: This feature is experimental: As Grazie is a new plugin and the API of Grazie might change, only the latest version of IntelliJ 2019.2 and 2019.2-5.3.stable is supported.
