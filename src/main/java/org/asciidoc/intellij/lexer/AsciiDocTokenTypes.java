...
public interface AsciiDocTokenTypes {
  ...
  IElementType ATTRIBUTE_DECL = new AsciiDocElementType("ATTRIBUTE_DECL");
  ...
  TokenSet TOKENS_TO_MERGE = TokenSet.create(TEXT, LISTING_TEXT, HEADING, TITLE, BLOCK_COMMENT,
      ...
      MONO_START, MONO_END, MONO, MONOBOLD, MONOBOLDITALIC, REF, BLOCKID, BLOCKREFTEXT, REFTEXT, WHITE_SPACE,
      ATTRIBUTE_VAL);
}
