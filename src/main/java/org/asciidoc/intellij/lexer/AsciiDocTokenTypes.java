...
public interface AsciiDocTokenTypes {
  ...
  IElementType INLINE_ATTR_NAME = new AsciiDocElementType("INLINE_ATTR_NAME");
  IElementType INLINE_ATTR_VALUE = new AsciiDocElementType("INLINE_ATTR_VALUE");
  ...
  TokenSet TOKENS_TO_MERGE = TokenSet.create(TEXT, LISTING_TEXT, HEADING, TITLE, BLOCK_COMMENT,
      ...
      LINKFILE, LINKANCHOR, ATTRIBUTE_NAME, ATTRIBUTE_VAL, ATTRIBUTE_REF, LITERAL_BLOCK, URL_LINK, URL_EMAIL, HEADER);
}
