...
public interface AsciiDocTokenTypes {
  ...
  IElementType DESCRIPTION_END = new AsciiDocElementType("DESCRIPTION_END");
  ...
  IElementType HEADING_TOKEN = new AsciiDocElementType("HEADING_TOKEN");
  ...
  IElementType ATTR_LIST_OP = new AsciiDocElementType("ATTR_LIST_OP");
  ...
  IElementType MACROTEXT = new AsciiDocElementType("MACROTEXT");
  ...
  IElementType ATTRIBUTE_SOFTSET = new AsciiDocElementType("ATTRIBUTE_SOFTSET");
  ...
  IElementType CELLSEPARATOR = new AsciiDocElementType("CELLSEPARATOR");
  IElementType ARROW = new AsciiDocElementType("ARROW");
