...
=== 0.31.1 (preview, available from GitHub releases)

- disable paste-image-handler as it is broken 2020.2: This is a temporary release while no EAP version of 2020.2 is available. Only users of 2020.2 should install it. (#486)

=== 0.30.74 (work in progress)
