...
- in Antora component descriptors, support auto-complete for keys _nav_ and _start_page_ (#768)
...
- when diagram rendering generates an exception, catch and add listing block (#772)

=== 0.32.52

- fixing opening wrong editor for antora.yml files (#768)
...
- robust parsing whitespace for grammar checker (#752)
...
- fix problem when parsing whitespace for grammar checker (#752)
