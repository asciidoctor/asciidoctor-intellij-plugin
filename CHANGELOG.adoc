...
=== 0.30.28 (work in progress)

- support xref with anchors, including auto-gerated IDs for sections (#373)
- support Antora module and component prefixes for block and inline macros (#373)
