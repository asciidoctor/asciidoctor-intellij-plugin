...
- Added code execution in the JCEF Preview rendering.
- Added code execution support for JavaScript, PowerShell, Python and Ruby.
- Added code copying to the JCEF Preview rendering.
- Updated `highlight.min.js` from 10.7.2 to 11.11.1.
- Added the following langauges to `highlight.min.js`:
    AspectJ, Basic, Delphi, Dockerfile, GLSL, Gradle,
    GraphQL, Handlebars, Latex, PowerShell, Scala.
