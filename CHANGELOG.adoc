...
=== 0.30.38 (work in progress)

- title can now start with a dot; improved parsing of titles (#400)
- allow pasting image from the clipboard with standard page shortcut (#402)
- auto-suggest block and section IDs from included file when autocomleting anchors in links (#403)
