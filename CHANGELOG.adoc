...
=== 0.30.83 (preview, available from GitHub releases)

- publish file information to allow status with a filename in IntelliJ Discord plugin (#518)
- first support for Asciidoclet (#103)

=== 0.30.82 (preview, available from GitHub releases)

- mark indexes to be rebuilt due to AST changes (#508)

=== 0.30.81 (preview, available from GitHub releases)

- avoid error "`ProcessCanceledException should not be logged`"
...
=== 0.30.80 (preview, available from GitHub releases)
...
=== 0.30.79 (preview, available from GitHub releases)
