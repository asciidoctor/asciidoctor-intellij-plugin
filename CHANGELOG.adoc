...
=== 0.28.4 (work in progress)

- autocompletion for attributes and attribute references (`:attr:` and `\{attr}`)

=== 0.28.3 (preview, available from Github releases)
...
=== 0.28.2 (preview, available from Github releases)
