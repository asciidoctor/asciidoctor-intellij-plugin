...
- disable error reporting for grammar handling in 2021.1 as it is re-written for 2021.2 (#818)

=== 0.33.20

- prevent NPE when accessing parent folder of a file (#847)
- lighter color for caption titles in dark mode in the preview (#841)
- limit 0.33.x version branch to versions IntelliJ versions 2020.3 to 2021.1
