...
- support Antora families like `example$` and `partials$` for macros in the editor. Only module-local references supported for now. (#373)
- support Antora families like `example$` and `partials$` for include macros in the preview. Only module-local references supported for now. (#373)
