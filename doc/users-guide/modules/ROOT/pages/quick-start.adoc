...
A minimal guide for those already familiar with their JetBrains IntelliJ based IDE.
...
[WARNING]
--
Please the pre-bundled JetBrains OpenJDK Runtime 11 to run your IDE. This provides the best live preview based on JavaFX. You can check this in the menu menu:Help[About].
