...
The block between the `====` marks and which shows with a yellow background in the preview contains the instructions.
It also contains links to the AsciiDoc language documentation which contain information to find a solution for the exercise.
