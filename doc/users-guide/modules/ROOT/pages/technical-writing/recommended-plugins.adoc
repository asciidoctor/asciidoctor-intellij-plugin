...
[NOTE]
====
* IntelliJ 2022.3 is not supported as described in bug https://youtrack.jetbrains.com/issue/IDEA-307064[IDEA-307064].
Update to IntelliJ version 2022.3.1 Preview or later for this to work.
