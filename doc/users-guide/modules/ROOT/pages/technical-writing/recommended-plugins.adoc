...
=== Spell checking for additional languages with Hunspell
...
Those can be used together with IntelliJ with the https://plugins.jetbrains.com/plugin/10275-hunspell[Hunspell plugin].

[NOTE]
====
* IntelliJ 2022.3 is not supported at the time of writing. Follow https://youtrack.jetbrains.com/issue/IDEA-307064[IDEA-307064] for updates.
* The Czech dictionary in the JetBrains hunspell-dictionaries repo has a broken encoding at the time of writing. Follow https://github.com/JetBrains/hunspell-dictionaries/pull/3[JetBrains/hunspell-dictionaries#3] for updates.
====
