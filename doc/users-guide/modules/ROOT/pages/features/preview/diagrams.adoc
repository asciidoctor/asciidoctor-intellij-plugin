...
The preview of the AsciiDoc plugin supports rendering the diagrams in of your AsciiDoc documents. Two different types of diagram renderes are supported: <<asciidoctor-diagram>> and <<kroki>>.
