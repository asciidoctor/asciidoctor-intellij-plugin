...
Please use the JDK provided by JetBrains for best results.
Please use the JetBrains OpenJDK 11 runtime whenever possible.
...
NOTE: See xref:features/preview/jcef-preview.adoc[] for more information on Android Studio 4.2.
...
* OpenJDK installations provided on Linux OS sometimes don't include JavaFX, therefore the JavaFX preview is not available.
