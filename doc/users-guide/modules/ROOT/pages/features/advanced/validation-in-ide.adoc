...
+
New in plugin version 0.37.55+: The plugin also adds two custom scopes: _AsciiDoc files_ and _AsciiDoc files without Symlinks_, which are applied to the whole project.
