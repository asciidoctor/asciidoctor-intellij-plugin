...
Running Microsoft Windows there seems to be a problem that JRuby can't read a folder name when contains non-US-ASCII characters that would require a UTF-8 encoding.
...
[#fileencoding]
=== Add file encoding VM option to IDE
