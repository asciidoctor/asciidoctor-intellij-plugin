...
Up to and including IntelliJ IDEA 2020.1 the pre-bundled OpenJDK includes JavaFX, with is required for a rich preview.
...
From IntelliJ 2020.2 onward the plugin supports the JCEF browser preview.
