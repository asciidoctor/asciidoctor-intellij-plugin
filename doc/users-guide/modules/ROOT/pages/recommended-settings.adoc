...
If the preview is blurry, xref:faq/blurry-preview.adoc[follow these instructions to remedy this].

[#enable-javafx-jcef-for-android-studio]
=== Enable JavaFX or JCEF for Android Studio

To use a rich preview for Android Studio, download additional components.
