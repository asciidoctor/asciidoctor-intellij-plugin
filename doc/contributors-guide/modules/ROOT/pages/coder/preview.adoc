...
User can install the https://plugins.jetbrains.com/plugin/14250-javafx-runtime-for-plugins[JavaFX for plguins^] on 64bit JREs to to re-enable the JavaFX preview.
