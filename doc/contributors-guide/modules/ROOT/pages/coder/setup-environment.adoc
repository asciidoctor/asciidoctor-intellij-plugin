...
Starting with IntelliJ 2026.2, JDK 25 is required to build the plugin, as IntelliJ 2026.2 uses JDK 25. The runtime version of the plugin is still compatible with JDK 21.

The AsciiDoc plugin uses only language features of Java 21 to allow the built plugin to run with earlier versions of IntelliJ as well.
...
In IntelliJ, go to menu:File[Project Structure... > Project Settings > Project > SDK] and select `coretto-25` as the JDK.
...
Groovy:       ...
Ant:          ...
JVM:          25.0.x (Amazon.com Inc. 25.0....)
OS:           ...
----
